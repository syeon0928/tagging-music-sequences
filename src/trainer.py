...
class Trainer:
    ...
    def train(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            pbar.set_postfix({'epoch': epoch + 1, 'training loss': avg_loss, 'validation loss': val_loss})
            pbar.update(1)
    ...
    # (same for train, val, and evaluate as all based on predicted and true labels)
    # def ...
